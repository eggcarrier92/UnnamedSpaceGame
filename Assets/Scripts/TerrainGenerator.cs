...
public class TerrainGenerator : MonoBehaviour
{
    ...
    [SerializeField] private float _perlinNoiseScale = .5f;
    ...
    private void ResetTerrain()
    {
        ...
        _shape.spline.SetLeftTangent (0, new Vector3(1, 0));
        _shape.spline.SetRightTangent(0, new Vector3(-1, 0));

        _shape.spline.SetPosition(1, new Vector3(-1,  1));
        _shape.spline.SetLeftTangent (1, new Vector3(-1, 0));
        _shape.spline.SetRightTangent(1, new Vector3(1, 0));

        _shape.spline.SetPosition(2, new Vector3(1,  1));
        _shape.spline.SetLeftTangent (2, new Vector3(-1, 0));
        _shape.spline.SetRightTangent(2, new Vector3(1, 0));

        _shape.spline.SetPosition(3, new Vector3(1, -1));
        _shape.spline.SetLeftTangent (3, new Vector3(1, 0));
        _shape.spline.SetRightTangent(3, new Vector3(-1, 0));
